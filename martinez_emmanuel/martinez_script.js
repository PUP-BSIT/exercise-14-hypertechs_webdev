function addComment() {
  ...
  function sortComments(order) {
    ...
    comments.sort((a, b) => {
      let timestampA = new Date(a.querySelector('.comment-timestamp').getAttribute('data-timestamp'));
      let timestampB = new Date(b.querySelector('.comment-timestamp').getAttribute('data-timestamp'));
